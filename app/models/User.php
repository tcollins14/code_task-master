...
class User extends Eloquent
{
  ...
  protected $fillable = ['title', 'forename', 'surname', 'gender', 'dob', 'email', 'password', 'password_confirmation'];
  ...
  $this->activation_token = $token->getValue();
	...
	['title' => $this->title, 'forename' => $this->forename, 'surname' => $this->surname, 'gender' => $this->gender, 'dob' => $this->getFormattedDate($this->date), 'email' => $this->email, 'password_hash' => $password_hash, 'activation_hash' => $hashed_token]
	);
	...
	public function validate()
    {
      // Title
       ...
       // Forename
       if ($this->forename == '') {
           $this->errors[] = 'Forename is required';
       }
       ...
       $this->setForename($this->forename);
    ...
    $this->date = $this->getFormattedDate($data['date']);
    ...
    $query = array("title" => $this->title, "forename" => $this->forename, "surname" => $this->surname, "email" => $this->email, "gender" => $this->gender, "dob" => $this->date
    );
